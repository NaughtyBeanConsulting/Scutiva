...
- Linux hardening and posture review with Lynis
...
4. Add graph correlation between vulnerabilities, misconfigurations, secrets, identities, and exposed services.
5. Add standards-grade export formats such as CycloneDX, SPDX, and SARIF.
6. Add benchmark-to-control mapping views for CIS, NIST, ISO 27001, and SOC 2 evidence generation.