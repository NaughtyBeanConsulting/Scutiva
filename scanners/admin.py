...
class ScanProfileAdmin(admin.ModelAdmin):
	list_display = ("name", "schedule", "severity_threshold", "enable_syft", "enable_grype", "enable_trivy", "enable_lynis", "enable_openscap", "is_default")
	list_filter = ("schedule", "severity_threshold", "enable_syft", "enable_grype", "enable_trivy", "enable_lynis", "enable_openscap", "is_default")


@admin.register(ScannerInstallation)
class ScannerInstallationAdmin(admin.ModelAdmin):
	list_display = ("server", "status", "syft_version", "grype_version", "trivy_version", "lynis_version", "openscap_version", "last_install_date")
	list_filter = ("status",)
