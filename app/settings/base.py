...
SSH_CONNECT_TIMEOUT = env_int("SSH_CONNECT_TIMEOUT", 15)
SSH_BANNER_TIMEOUT = env_int("SSH_BANNER_TIMEOUT", 15)
SSH_AUTH_TIMEOUT = env_int("SSH_AUTH_TIMEOUT", 15)
SSH_CONNECT_RETRIES = env_int("SSH_CONNECT_RETRIES", 2)
SSH_RETRY_DELAY_SECONDS = env_int("SSH_RETRY_DELAY_SECONDS", 2)
SSH_AUTO_ADD_HOST_KEYS = env_bool("SSH_AUTO_ADD_HOST_KEYS", True)
